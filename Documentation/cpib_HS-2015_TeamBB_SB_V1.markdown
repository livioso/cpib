...
### Abstract
Die Erweiterung **Records in IML** wurden als eigener Typ `record` umgesetzt. Die Implementation des Compilers wurde in Swift
...
- v1 := v2: Möglich?
- v1.y := v1.x + 5?
- Generell: Änderungen beim Scanner (kurz) erwähnen.
